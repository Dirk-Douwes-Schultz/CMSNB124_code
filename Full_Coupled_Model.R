...
#bring in data
load("C:/Users/dirkd/OneDrive/Documents/GitHub/CMSNB124_code/Quebec_hospital_study_data.RData")
...
#for the intial S I think I will do it custom 
...
#now I need to draft a iFFBS sampler
loc_test <- 1
...
##########################################################
#now need to draft a sampler for the marginal likelihood
...
#I dont think this is really neccessary to update these, but I will do it anyway
...
samples <- runMCMC(ChospitalMCMC,  niter =200000,nchains = 1,nburnin=50000
                   ,samplesAsCodaMCMC = TRUE,thin=15,inits = initsFunction)

#save(samples, hold_out,S_partial_class, file="C:/Users/dirkd/OneDrive/Documents/COVID_hospital/results/variant_model_gelmanpriors.RData")
save(samples, file=paste0("C:/Users/dirkd/OneDrive/Documents/COVID_hospital/results/full_coupled_test_git_shrunk_",chain,".RData"))
